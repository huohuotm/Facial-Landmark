    ...
    if weights == 'vggface':
        if include_top:
            weights_path = get_file('rcmalli_vggface_tf_v2.h5',
                                    utils.
                                    WEIGHTS_PATH,
                                    cache_dir = os.getcwd(), # /Users/zouxiaxia/Documents/Study/Projects/Facial-Landmark
                                    cache_subdir='pretrained_vggface_model')
        else:
        ...
        # if include_top and os.path.isfile("models/rcmalli_vggface_tf_v2.h5"):
        #     weights_path = "models/rcmalli_vggface_tf_v2.h5"
        # elif (not include_top) and os.path.isfile("models/rcmalli_vggface_tf_notop_v2.h5"):
        #     weights_path = "models/rcmalli_vggface_tf_notop_v2.h5"
